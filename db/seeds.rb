...
User.create([
  ...
  {email: 'fl@fl.com', admin: true, password: 'fredfred', password_confirmation: 'fredfred', first_name: 'Fredrick', last_name: 'Longfellow' , city: 'New York', state: 'NY', zip: "11238", phone: '+1(567)567-5678', address: '1 Google Drive', credit_number: '4444444444444444', server_code: '3546'},
  {email: 'jp@jp.com', admin: true, password: 'janejane', password_confirmation: 'janejane', first_name: 'Jane', last_name: 'Peppermill' , city: 'New York', state: 'NY', zip: "11238", phone: '6786786789', address: '1 Google Drive', credit_number: '4444444444444444', server_code: '4321'},
  {email: 'tayloraddison1@gmail.com', admin: true, password: 'drinkb06', password_confirmation: 'drinkb06', first_name: 'Taylor', last_name: 'Addison' , city: 'Tuscaloosa', state: 'AL', zip: "35401", phone: '2052920078', address: '2610 Packberry Lane', credit_number: '2222222222222222', server_code: '8642'}
])
