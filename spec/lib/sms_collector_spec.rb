...
describe SmsCollector do
    ...
    it "should accept the word hash and create gifts" do
        stub_request(:get, "http://pub_fa0f3e7f9ddaeefc89ca3d40d93c2472:0cc8841e131a2ecdc690a4d2e7b5a676255e26a8@api.slicktext.com/v1/contacts?limit=1000&textword=15893").to_return(:status => 200, :body =>  @sample_response, :headers => {})
        user = FactoryGirl.create(:user, phone: "5555555555")
        textword = "itsonme"
        provider = FactoryGirl.create(:provider)
        campaign = FactoryGirl.create(:campaign)
