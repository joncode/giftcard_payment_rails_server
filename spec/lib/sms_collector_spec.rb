...
TEXTWORDS = [
    {"id"=>"15892", "word"=>"its on me", "autoReply"=>"Welcome to It's On Me!  You're one click away from gifting! iPhone Users: http://www.sos.me/join Android Users Can Join Our Alpha Here: http://www.sos.me/aJoin", "added"=>"2013-10-11 13:45:57", "optOuts"=>"1", "ageRequirement"=>"0"},
    {"id"=>"15893", "word"=>"itsonme", "autoReply"=>"Welcome to It's On Me!  You're one click away from gifting! iPhone Users: http://www.sos.me/join Android Users Can Join Our Alpha Here: http://www.sos.me/aJoin", "added"=>"2013-10-11 13:46:16", "optOuts"=>"0", "ageRequirement"=>"0"},
    {"id"=>"17429", "word"=>"no kid hungry", "autoReply"=>"Welcome to It's On Me!  You're one click away from gifting! iPhone Users: http://www.sos.me/join Android Users Can Join Our Alpha Here: http://www.sos.me/aJoin", "added"=>"2013-10-17 09:57:19", "optOuts"=>"0", "ageRequirement"=>"0"},
    {"id"=>"68214", "word"=>"drinkboard", "autoReply"=>"This is a test! Go to http://bit.ly/O3eRbm to download the IOM app and receive your test campaign gift! If you're already an IOM user, check your Gift Center!", "added"=>"2014-03-12 14:32:36", "optOuts"=>"0", "ageRequirement"=>"21"}
]
CONTACTS_RESPONSE = [
    {"service_id"=>"11111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345839"},
    {"service_id"=>"21111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345323"},
    {"service_id"=>"31111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345589"},
    {"service_id"=>"41111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345109"},
    {"service_id"=>"51111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345722"},
    {"service_id"=>"61111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345752"},
    {"service_id"=>"71111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345844"},
    {"service_id"=>"81111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345178"},
    {"service_id"=>"91111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345385"},
    {"service_id"=>"10111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345978"},
    {"service_id"=>"11111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345378"},
    {"service_id"=>"12111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345912"},
    {"service_id"=>"13111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345453"},
    {"service_id"=>"14111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345266"},
    {"service_id"=>"15111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345644"},
    {"service_id"=>"16111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345637"},
    {"service_id"=>"17111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345309"},
    {"service_id"=>"18111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345790"},
    {"service_id"=>"19111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345349"},
    {"service_id"=>"20111", "service"=>"slicktext", "textword"=>"itsonme", "subscribed_date"=>"Mon, 04 Feb 2013 21:12:45 +0000", "phone"=>"3234345595"}
]
...
describe SmsCollector do
    ...
    context "bug fixes" do
        ...
        it "should not break on :count" do
            ...
            cam_item = FactoryGirl.create(:campaign_item, campaign_id: campaign.id, textword: textword, merchant_id: provider.id, expires_at: (Time.now + 1.month))
    ...
    context "multiple campaign_items sharing a textword" do
        ...
        it "should allow campaign items to share textwords and pick random item" do
            SmsContact.delete_all
            textword  = "itsonme"
            provider1 = FactoryGirl.create(:merchant, name: "First one")
            provider2 = FactoryGirl.create(:merchant, name: "Second one")
            provider3 = FactoryGirl.create(:merchant, name: "Third one")
            campaign  = FactoryGirl.create(:campaign)
            cam_item1 = FactoryGirl.create(:campaign_item, campaign_id: campaign.id, textword: textword, merchant_id: provider1.id, updated_at: (Time.now - 60.minutes), expires_at: (Time.now + 1.month))
            cam_item2 = FactoryGirl.create(:campaign_item, campaign_id: campaign.id, textword: textword, merchant_id: provider2.id, updated_at: (Time.now - 50.minutes), expires_at: (Time.now + 1.month))
            cam_item3 = FactoryGirl.create(:campaign_item, campaign_id: campaign.id, textword: textword, merchant_id: provider3.id, updated_at: (Time.now - 40.minutes), expires_at: (Time.now + 1.month))
        ...
        it "should not make any gifts for campaign item if the campaign is not live" do
            ...
            cam_item1 = FactoryGirl.create(:campaign_item, campaign_id: campaign.id, textword: textword, merchant_id: provider1.id, updated_at: (Time.now - 60.minutes), expires_at: (Time.now + 1.month))
            cam_item2 = FactoryGirl.create(:campaign_item, campaign_id: campaign2.id, textword: textword, merchant_id: provider2.id, updated_at: (Time.now - 50.minutes), expires_at: (Time.now + 1.month))
            cam_item3 = FactoryGirl.create(:campaign_item, campaign_id: campaign.id, textword: textword, merchant_id: provider3.id, updated_at: (Time.now - 40.minutes), expires_at: (Time.now + 1.month))
...
describe "Reused Textword Gifting" do
    ...
    it "should send a gift for a correct textword" do
        ...
        campaign      = FactoryGirl.create :campaign
        campaign_item = FactoryGirl.create :campaign_item, campaign_id: campaign.id, textword: "hamburger", merchant_id: provider.id, expires_at: (Time.now + 1.month)
    ...
    it "should allow textwords to be reused" do
        ...
        campaign_item1 = FactoryGirl.create :campaign_item, campaign_id: campaign1.id, textword: "hamburger", merchant_id: provider.id, expires_at: (Time.now + 1.month)
        user           = FactoryGirl.create :user, phone: "2223334444"
        Slicktext.should_receive(:textwords).and_return([{ "word" => "hamburger" }])
        Slicktext.should_receive(:get).and_return({ "contacts" => [{ "id" => "1", "number" => "2223334444", "subscribedDate" => Time.now.to_s }] })
        Gift.count.should == 0
        ...
        campaign_item2 = FactoryGirl.create :campaign_item, campaign_id: campaign2.id, textword: "hamburger", merchant_id: provider.id, expires_at: (Time.now + 1.month)
        Slicktext.should_receive(:textwords).and_return([{ "word" => "hamburger" }])
