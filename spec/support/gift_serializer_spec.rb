shared_examples_for "gift serializer" do
    ...
    it "should admt_serialize" do
        keys = ["gift_id", "provider_id", "name", "merchant_address", "value", "cost", "updated_at", "pay_type", "cat" ]
        keys << "expires_at"     if object.expires_at
    ...
    it "should report_serialize" do
        keys = ["order_num","updated_at","created_at","receiver_name","items","server","value", "cost", "cat" ]
        keys << "completed_at" if object.redeemed_at
        keys << "expires_at"   if object.expires_at
    ...
    it "should promo_serialize" do
        keys = ["value", "cost", "receiver_name", "receiver_email", "shoppingCart", "status", "updated_at", "created_at", "items", "cat" ]
        keys << "completed_at"   if object.redeemed_at
        keys << "expires_at"     if object.expires_at
        keys << "receiver_photo" if object.receiver
