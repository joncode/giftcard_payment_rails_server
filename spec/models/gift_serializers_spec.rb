...
describe GiftSerializers do
    ...
    [@old_gift, regift].each do |gift|
        ...
        it "should serialize" do
            keys = [ "gift_id", "giver","giver_photo" ,"receiver" ,"receiver_photo","receiver" ,"message","shoppingCart" ,"merchant_name" ,"merchant_address" ,"merchant_phone" ]
            keys.delete("receiver_photo")
            hsh = gift.serialize
