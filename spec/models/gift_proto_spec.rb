...
describe GiftProto do
    ...
    it_should_behave_like "gift serializer" do
        let(:object) { GiftProto.create(@gift_hsh) }
    end

    it "should create gift" do
        gift_proto = GiftProto.create(@gift_hsh)
        gift_proto.class.should    == GiftProto
        gift_proto.detail.should         == "this is good through 9PM"
        gift_proto.message.should        == @gift_hsh["message"]
        gift_proto.receiver_name.should  == "Customer Name"
        gift_proto.receiver_email.should == "customer@gmail.com"
        gift_proto.provider_id.should    == @provider.id
        gift_proto.provider_name.should  == @provider.name
    ...
    it "should set the giver info to the BizUser" do
        ...
        gift = GiftProto.create @gift_hsh
        gift.reload
    ...
    context "messaging" do
        ...
        it "should not email invoice to the sender" do
            ...
            response = GiftProto.create @gift_hsh
