...
describe GiftCampaign do
    ...
    context "ItsOnMe Campaign" do
        ...
        it "should not create gift if the campaign is not yet live" do
            ...
            gift = GiftCampaign.create @gift_hsh
            gift.errors.count.should == 1
            gift.errors.full_messages[0].should == "Campaign Special Promotion - textword (11111) has not started yet. No gifts can be created."
        end
        ...
        it "should not create gift if the campaign is closed" do
            ...
            gift = GiftCampaign.create @gift_hsh
            gift.errors.count.should == 1
            gift.errors.full_messages[0].should == "Campaign Special Promotion - textword (11111) is closed. No gifts can be created."
        end
