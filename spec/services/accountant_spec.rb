...
describe Accountant do
	...
	describe "merchant" do
		...
		it "should create debt 85% in register for the merchant" do
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 300)
			resp = Accountant.merchant(g)
			reg  = Register.last
		...
		it "should use the price promo for 100 cat gift" do
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, receiver_id: u.id, value: "100", cost: "1.50", cat: 100, status: 'open')
		...
		it "should use the price promo for 150 cat gift" do
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, receiver_id: u.id, value: "100", cost: "2", cat: 150, status: 'open')
			g.notify
			g.redeem_gift
			resp  = Accountant.merchant(g)
			resp2 = Accountant.merchant(g)
		...
		it "should do nothing for 200, 250 , any 7, any 1" do
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 200)
			resp  = Accountant.merchant(g)
			resp.should == "no Debt Amount"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 201)
			resp = Accountant.merchant(g)
			resp.should == "no Debt Amount"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 207)
			resp = Accountant.merchant(g)
			resp.should == "no Debt Amount"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 250)
			resp = Accountant.merchant(g)
			resp.should == "no Debt Amount"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 251)
			resp = Accountant.merchant(g)
			resp.should == "no Debt Amount"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 257)
			resp = Accountant.merchant(g)
			resp.should == "no Debt Amount"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 301)
			resp = Accountant.merchant(g)
			resp.should == "Not redemption not a purchase"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 307)
			resp = Accountant.merchant(g)
			resp.should == "Not redemption not a purchase"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 101)
			resp = Accountant.merchant(g)
			resp.should == "Not redemption not a purchase"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 107)
			resp = Accountant.merchant(g)
			resp.should == "Not redemption not a purchase"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 151)
			resp = Accountant.merchant(g)
			resp.should == "Not redemption not a purchase"
			g    = FactoryGirl.create(:gift, merchant_id: m1.id, value: "100", cat: 157)
			resp = Accountant.merchant(g)
			resp.should == "Not redemption not a purchase"
	...
	describe "affiliate" do
		...
		context "merchant affiliate" do
			...
			it "should not create debt if there is no merchant affiliate" do
				...
				g = FactoryGirl.create(:gift, merchant_id: m.id, value: "100", cat: 300)
				resp = Accountant.affiliate_location(g)
				resp.should == false
				Register.all.count.should == 0
			end
		...
		it "should do nothing for 100, 150, 200, 250 , any 7, any 1" do
			...
			a1.users << user
			a1.merchants << m1
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id, value: "100", cat: 200)
			resp  = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 201)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 207)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 250)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 251)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 257)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 100)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 101)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 107)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 150)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
			g = FactoryGirl.create(:gift, giver: user, merchant_id: m1.id,  value: "100", cat: 151)
			resp = Accountant.affiliate_user(g)
			resp2 = Accountant.affiliate_location(g)
			resp.should  be_false
			resp2.should be_false
