shared_examples_for "gift serializer" do
    ...
    it "should badge_serialize" do
        keys = ["r_sys",  "items","giver_id", "giver_name", "provider_id", "provider_name", "message", "detail",  "updated_at", "created_at", "status", "shoppingCart", "giver_photo", "provider_photo", "provider_phone", "city", "latitude", "longitude", "live", "provider_address", "gift_id", "time_ago", "cat" ]
        keys << "expires_at"     if object.expires_at
    ...
    it "should giver_serialize" do
        keys = ["items","created_at", "message", "detail",  "provider_id", "provider_name", "receiver_id", "receiver_name", "value", "cost", "updated_at", "shoppingCart", "gift_id", "status", "provider_photo", "provider_phone", "city", "latitude", "longitude", "live", "provider_address", "time_ago", "cat" ]
    ...
    it "should receiver_serialize" do
        keys = ["items","giver_id", "giver_name", "message", "detail",  "provider_id", "provider_name", "shoppingCart", "updated_at", "created_at", "gift_id", "status", "giver_photo", "provider_photo", "provider_phone", "city", "latitude", "longitude", "live", "provider_address", "time_ago", "cat" ]
        keys << "completed_at" if object.redeemed_at
        keys << "expires_at"   if object.expires_at
