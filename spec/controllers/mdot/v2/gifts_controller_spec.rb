...
describe Mdot::V2::GiftsController do
    ...
    describe :index do
        ...
        it "should serialize the gifts with defined keys" do
            ...
            keys = ['brand_card', 'multi_loc',"city_id", "region_id",  "region_name", "r_sys","created_at", "giv_name", "giv_photo", "giv_id", "giv_type", "rec_id", "rec_name", "rec_photo", "items", "value", "status", "expires_at", "cat", "msg", "loc_id", "loc_name", "loc_phone", "loc_address", "gift_id"]
    ...
    describe :archive do
        ...
        it "should send used gifts with receiver keys" do
            ...
            keys = ['brand_card', 'multi_loc',"r_sys", "region_name",  "city_id", "region_id", "giver_id", "giver_name",
    ...
    describe :badge do
        ...
        it "should return receiver serialized gifts" do
            ...
            keys = ['brand_card', 'multi_loc',"city_id", "region_name",  "region_id","value", "r_sys", "giver_id",
