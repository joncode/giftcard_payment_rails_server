...
describe Web::V3::PromosController do
	...
	describe "create" do
		...
		it "should require a link campaign_item_id rec_net_id & rec_net" do
            ...
            keys = ["city_id", "region_id","r_sys", "created_at", "giv_name", "giv_photo", "detail", "giv_id", "giv_type", "rec_name", "items", "value", "status", "expires_at", "cat", "msg", "loc_id", "loc_name", "loc_phone", "loc_address", "gift_id"]
