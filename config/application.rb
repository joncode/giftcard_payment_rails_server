FILTER_PARAMS = [:password, :password_confirmation, :password_digest, :token, :remember_token, :merchant_token, :merchant_tkn, :uid, :credit_number, :card_number, :verification_value, :confirm_email_token, :confirm_phone_token]
