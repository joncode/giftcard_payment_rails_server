...
class PaymentGatewayCim
    ...
    def self.create_customer_profile customer_id
        profile  = AuthorizeNet::CIM::CustomerProfile.new(id: customer_id)
    ...
    def self.create_profile_with_payment_profile card, card_number, customer_id
