...
#	-------------
	...
	def process_card_validation card
		...
		@brand = card.brand.downcase if card.brand.respond_to?(:downcase)
		if (card.address_zip_check == 'pass') && (card.address_line1_check == 'pass') && (card.cvc_check == 'pass')
			process_card_success card
		elsif (card.address_zip_check == 'pass') && (card.address_line1_check.nil?) && (card.cvc_check == 'pass')
			process_card_success card
