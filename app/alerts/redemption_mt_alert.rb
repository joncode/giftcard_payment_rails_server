...
#   -------------
	...
	def get_data
		...
		@data = "#{redemption.receiver_name} has redeemed a #{redemption.amount_s} redemption(#{redemption.paper_id}.  Status is #{redemption.status}.  Gift #{redemption.gift.paper_id}}"
	end
