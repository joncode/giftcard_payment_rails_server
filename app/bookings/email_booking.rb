class EmailBooking < EmailAbstract
	...
	def set_vars
		h = { 	'book_name' => @booking.book_name,
				...
				'booking_price_subtotal' => display_money(ccy: @booking.ccy, cents: @booking.price_subtotal),
				'booking_price_total' => display_money(ccy: @booking.ccy, cents: @booking.price_total),
				'tax_amount' => display_money(ccy: @booking.ccy, cents: @booking.tax_amount),
				'tax_name' => @booking.tax_name,
				'tip_amount' => display_money(ccy: @booking.ccy, cents: @booking.tip_amount),
				'tip_name' => @booking.tip_name,
				'tax_tip_included' => @booking.tax_tip_included,
