                    ...
                    <Panel>
                      <PanelBody style={{padding: 0}}>
                        <div className='text-center bg-darkblue fg-white'>
                          <h3 style={{margin: 0, padding: 25}}>Sign in to PartnerTools</h3>
                        </div>
                        ...
                        <div>
                          <div className='text-center' style={{padding: 12.5}}>
                            or use your PartnerTools account
                          </div>
                            ...
                            <Form onSubmit={this.back}>
                              <FormGroup>
                                <InputGroup lg>
                                  ...
                                  <Input autoFocus type='email' id='emailaddress' className='border-focus-blue' placeholder='partner@itson.me' />
                                </InputGroup>
                              </FormGroup>
                              <FormGroup>
                                <InputGroup lg>
                                ...
                                <Grid>
                                  <Row>
                                    <Col xs={6} collapseLeft collapseRight style={{paddingTop: 10}}>
                                      <Link href='/app/signup'>Create a PartnerTools account</Link>
                                    </Col>
