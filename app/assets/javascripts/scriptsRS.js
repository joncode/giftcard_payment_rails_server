$(function() {
	...
	// Cock "Edit ITEMS" click functions
	$('#editItemsButtonCock a').click(function () {

		//swap out edit button images and a blocker divs on click
		$('#editItemsButtonCock').toggleClass('buttonSmallerUp');
		$('#editPricesButtonCock').addClass('buttonSmallerUp');
		$('#editPricesButtonCock').toggleClass('buttonDeadOpacity');
		$('.buttonHiderPrice').toggle();

		// Change the 2 edit box states		
		$('.cockEditWrapper, .buttonSaveCockItem').fadeToggle(100);
		$('.cockMenuBox').fadeToggle(100);
		return false;
			//end switch up/down images/class switch
	});
