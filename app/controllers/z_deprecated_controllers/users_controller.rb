...
# 	before_filter :signed_in_user , except: [:new, :create, :confirm_email]
# 	before_filter :admin_user? , except: [:new, :create, :confirm_email]
...
# 		respond_to do |format|
# 			format.html { redirect_to :controller => :invite, :action => action }
# 		end
# 	end
