...
private
    ...
    def merchant_params
        allowed = ["r_sys", "menu", "latitude", "longitude", "name", "zinger", "description", "address", "city", "state", "zip", "region_id", "phone", "merchant_id", "token", "image", "mode", "pos_merchant_id", "photo_l"]
