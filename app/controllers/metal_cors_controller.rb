...
private
    ...
    def cross_origin_allow_header
        ...
        headers['Access-Control-Allow-Headers']  = 'Origin, X-Requested-With, Content-Type, Accept, HTTP_X_AUTH_TOKEN, X_AUTH_TOKEN, x_auth_token, Mdot-Version, Android-Version'
    end
